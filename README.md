...
MISSION: Build and lead verification-first engineering teams that ship testable claims, auditable changes, bounded risk, reproducible results.
...
**Signal**: A claim is only credible when it is backed by runnable verification: CI, tests, and traceable artifacts.
...
| --- | --- | --- |
| Computational Autonomy and Undecidability | https://github.com/bradsaucier/autonomy-undecidability | quality-gate |
| Artemis Security Evidence | https://github.com/bradsaucier/artemis-security-evidence | docs-ci |
| CS-300 Course Planner | https://github.com/bradsaucier/CS300-CoursePlanner | ci |
...
| Verification and CI | Repeatable runs, automated gates, and evidence trails that survive turnover. | GitHub Actions, CI quality gates |
| Security evidence | Scoped claims, traceable artifacts, and verification notes. | Linux-first workflows; containers where they improve reproducibility. |
...
I apply 22 years of USAF Combat Control operational risk management to software delivery and engineering leadership. This is personal work and does not represent any employer or agency.
