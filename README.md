...
| Project | Focus | Gate |
|:--|:--|:--|
| [bradsaucier/robust-uav-hover-2d](https://github.com/bradsaucier/robust-uav-hover-2d) | 2D hover control verification: naive vs protected PID under seeded turbulence | [![ops](https://img.shields.io/github/actions/workflow/status/bradsaucier/robust-uav-hover-2d/operational_readiness.yml?label=ops&style=flat-square&logo=githubactions&logoColor=white)](https://github.com/bradsaucier/robust-uav-hover-2d/actions/workflows/operational_readiness.yml) |
...
| [bradsaucier/opsnormal](https://github.com/bradsaucier/opsnormal) | Local-only operator readiness tracking PWA with verified release artifact pipeline | [![ci](https://img.shields.io/github/actions/workflow/status/bradsaucier/opsnormal/ci.yml?label=ci&style=flat-square&logo=githubactions&logoColor=white)](https://github.com/bradsaucier/opsnormal/actions/workflows/ci.yml) |
